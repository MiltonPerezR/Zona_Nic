...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <ContentTemplate>
            <style>
                ...
                @media screen and (max-width: 768px) {
                    ...
                    .episodio-img-grid {
                        width: 130px; /* Puedes ajustar este valor */
                        height: 100%;
                        object-fit: cover;
                        flex-shrink: 0;
                    }
                ...
                @media screen and (min-width: 768px) {
                    .banner-container {
                        ...
                        overflow: hidden;
                        border-radius: 16px;
                        margin: 0 auto 20px auto; /* 👈 Esto centra horizontalmente */
                    }
            ...
            <div class="serie-info-container">
                <div class="serie-info-content">
                    ...
                    <asp:Label runat="server" ID="lblIdTipos" Style="display: none;"></asp:Label>
                    <p>
                        <asp:Label ID="Sinopsis" runat="server" />
                    </p>
                    <div class="action-buttons">
                        <asp:Button ID="btnVerAhora" runat="server" CssClass="btn-disney" Text="CONTINUAR" OnClick="btnVerAhora_Click" />
                        <asp:Button ID="btnLista" runat="server" CssClass="btn-disney-outline" Text="Mi Lista" OnClick="btnLista_Click" />
                    </div>
                </div>
            </div>
            ...
            <div class="tabs-container">
                    <span class="tab active" onclick="mostrarTab('episodios')">EPISODIOS</span>
                ...
                <asp:DropDownList ID="ddlTemporadas" runat="server" AutoPostBack="true" CssClass="season-dropdown" OnSelectedIndexChanged="ddlTemporadas_SelectedIndexChanged" />
                    </div>
                    ...
                    <div class="episodios-wrapper contain mt-4 mb-5">
                        <div class="episodios-grid">
                            <asp:Repeater ID="rptEpisodios" runat="server" OnItemCommand="rptEpisodios_ItemCommand">
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" CommandName="VerEpisodio" CommandArgument='<%# Eval("IdEpisodio") %>' CssClass="episodio-card-grid-link">
    ...
    <script>
        ...
        window.addEventListener("scroll", () => {
            ...
            const startColor = "rgb(0, 0, 0)"; // Café (#4b4242)
