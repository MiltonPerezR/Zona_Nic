...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        <div class="card card-custom p-4">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <label for="dsdsd" class="form-label">Clasificación edad</label>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <label for="txtSinopsis" class="form-label">Fecha de estreno</label>
                    <asp:TextBox ID="estreno" runat="server" CssClass="form-control" />
                </div>
